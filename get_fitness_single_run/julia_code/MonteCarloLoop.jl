function monte_carlo_loop!(params, const_params, dt, time_range, time_span, trials, pop_current)

    @unpack ΔE, ΔI, η_0E, η_0I, τE, τI = const_params
    PhenotypeParams = params
    ...
    for j = 1:trials
        ...
        pop_current[j, :] = run_mass_model(u0, dt, time_range, params, time_span)
    end
