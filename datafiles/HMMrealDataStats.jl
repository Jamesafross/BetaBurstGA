...
realdata_stats = [Burst_Dur_mean Burst_Number_mean   Burst_Power_mean;
                    Burst_Dur_std  Burst_Number_std  Burst_Power_std;
                    Burst_Dur_skew  Burst_Number_skew  Burst_Power_skew;
                    Burst_Dur_kurtosis  Burst_Number_kurtosis  Burst_Power_kurtosis;
                    ]
