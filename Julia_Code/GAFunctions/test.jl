...
SS1 = init_conds_SS(params) .+ 0.0001
SS2 = init_conds_SS(params2) .+ 0.0001

prob1 = ODEProblem(fdeterministic, SS1, tspan, params)
sol1 = solve(prob1, Tsit5(), saveat=0.0:0.1:4000)



prob2 = ODEProblem(fdeterministic, SS2, tspan, params2)
