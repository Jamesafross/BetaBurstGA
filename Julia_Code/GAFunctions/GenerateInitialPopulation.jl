...
function GenRandParams()
    ...
    InitPop[3:4,:] .= randNum(30,100,2)
    InitPop[5:8,:] .= randNum(0.1,8.0,4)
    InitPop[9:12,:] .= randNum(0.1,1.5,4)
    InitPop[13:16,:] .= randNum(0.0,0.5,4)
    InitPop[14,:] = InitPop[15,:]
    InitPop[17:18,:] .= randNum(1,20,2)
    InitPop[19:20,:] .= randNum(-1,-20,2)
    return InitPop
end
